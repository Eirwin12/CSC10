...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../audio.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41080
SOPC_SYSID_FLAG += --sidp=0x41080
ELF_PATCH_FLAG  += --sidp 0x41080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1766137401
SOPC_SYSID_FLAG += --timestamp=1766137401
ELF_PATCH_FLAG  += --timestamp 1766137401
