...
# Tue Nov 25 16:38:28 CET 2025
# DO NOT MODIFY


# 
# reg32_avalon_interface_v2 "reg32_component_test" v1.1
#  2025.11.25.16:38:28
# 
# 
...
# 
# module reg32_avalon_interface_v2
# 
set_module_property DESCRIPTION ""
set_module_property NAME reg32_avalon_interface_v2
set_module_property VERSION 1.1
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "My own IP cores"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME reg32_component_test
...
add_interface_port conduit_end_1 Q_export_2 readdata Output 32
...
set_interface_property avalon_slave_1 associatedReset clock_reset
...
add_interface_port avalon_slave_1 writedata_2 writedata Input 32
add_interface_port avalon_slave_1 readdata_2 readdata Output 32
add_interface_port avalon_slave_1 byteenable_2 byteenable Input 4
add_interface_port avalon_slave_1 chipselect_2 chipselect Input 1
add_interface_port avalon_slave_1 read_2 read Input 1
add_interface_port avalon_slave_1 write_2 write Input 1
