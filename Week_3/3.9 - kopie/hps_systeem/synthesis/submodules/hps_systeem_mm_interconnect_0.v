// hps_systeem_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module hps_systeem_mm_interconnect_0 (
		...
		input  wire        PIO_switch_reset_reset_bridge_in_reset_reset,                        //                        PIO_switch_reset_reset_bridge_in_reset.reset
		...
		output wire        PIO_switch_s1_write,                                                 //                                                              .write
		input  wire [31:0] PIO_switch_s1_readdata,                                              //                                                              .readdata
		output wire [31:0] PIO_switch_s1_writedata,                                             //                                                              .writedata
		output wire        PIO_switch_s1_chipselect                                             //                                                              .chipselect
	);
	...
	wire   [20:0] pio_switch_s1_agent_m0_address;                           // PIO_switch_s1_agent:m0_address -> PIO_switch_s1_translator:uav_address
	...
	wire  [114:0] pio_switch_s1_agent_rf_source_data;                       // PIO_switch_s1_agent:rf_source_data -> PIO_switch_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_switch_s1_agent_rsp_fifo_out_data;                    // PIO_switch_s1_agent_rsp_fifo:out_data -> PIO_switch_s1_agent:rf_sink_data
	...
	wire          pio_switch_s1_agent_rdata_fifo_src_valid;                 // PIO_switch_s1_agent:rdata_fifo_src_valid -> PIO_switch_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_switch_s1_agent_rdata_fifo_src_data;                  // PIO_switch_s1_agent:rdata_fifo_src_data -> PIO_switch_s1_agent_rdata_fifo:in_data
	wire          pio_switch_s1_agent_rdata_fifo_src_ready;                 // PIO_switch_s1_agent_rdata_fifo:in_ready -> PIO_switch_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] pio_led_s1_agent_m0_address;                              // PIO_led_s1_agent:m0_address -> PIO_led_s1_translator:uav_address
	...
	wire  [114:0] pio_led_s1_agent_rf_source_data;                          // PIO_led_s1_agent:rf_source_data -> PIO_led_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_led_s1_agent_rsp_fifo_out_data;                       // PIO_led_s1_agent_rsp_fifo:out_data -> PIO_led_s1_agent:rf_sink_data
	...
	wire          pio_switch_s1_agent_rp_valid;                             // PIO_switch_s1_agent:rp_valid -> router_002:sink_valid
	wire  [113:0] pio_switch_s1_agent_rp_data;                              // PIO_switch_s1_agent:rp_data -> router_002:sink_data
	wire          pio_switch_s1_agent_rp_ready;                             // router_002:sink_ready -> PIO_switch_s1_agent:rp_ready
	wire          pio_switch_s1_agent_rp_startofpacket;                     // PIO_switch_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          pio_switch_s1_agent_rp_endofpacket;                       // PIO_switch_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [113:0] pio_led_s1_agent_rp_data;                                 // PIO_led_s1_agent:rp_data -> router_003:sink_data
	...
	wire          pio_key_s1_agent_rp_valid;                                // PIO_key_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] pio_key_s1_agent_rp_data;                                 // PIO_key_s1_agent:rp_data -> router_004:sink_data
	wire          pio_key_s1_agent_rp_ready;                                // router_004:sink_ready -> PIO_key_s1_agent:rp_ready
	wire          pio_key_s1_agent_rp_startofpacket;                        // PIO_key_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          pio_key_s1_agent_rp_endofpacket;                          // PIO_key_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> PIO_switch_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> PIO_switch_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // PIO_switch_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> PIO_switch_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> PIO_switch_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> PIO_switch_s1_burst_adapter:sink0_endofpacket
	wire          pio_switch_s1_burst_adapter_source0_valid;                // PIO_switch_s1_burst_adapter:source0_valid -> PIO_switch_s1_agent:cp_valid
	wire  [113:0] pio_switch_s1_burst_adapter_source0_data;                 // PIO_switch_s1_burst_adapter:source0_data -> PIO_switch_s1_agent:cp_data
	wire          pio_switch_s1_burst_adapter_source0_ready;                // PIO_switch_s1_agent:cp_ready -> PIO_switch_s1_burst_adapter:source0_ready
	wire    [2:0] pio_switch_s1_burst_adapter_source0_channel;              // PIO_switch_s1_burst_adapter:source0_channel -> PIO_switch_s1_agent:cp_channel
	wire          pio_switch_s1_burst_adapter_source0_startofpacket;        // PIO_switch_s1_burst_adapter:source0_startofpacket -> PIO_switch_s1_agent:cp_startofpacket
	wire          pio_switch_s1_burst_adapter_source0_endofpacket;          // PIO_switch_s1_burst_adapter:source0_endofpacket -> PIO_switch_s1_agent:cp_endofpacket
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> PIO_led_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> PIO_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // PIO_led_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> PIO_led_s1_burst_adapter:sink0_channel
	...
	wire  [113:0] pio_led_s1_burst_adapter_source0_data;                    // PIO_led_s1_burst_adapter:source0_data -> PIO_led_s1_agent:cp_data
	...
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> PIO_key_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> PIO_key_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // PIO_key_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> PIO_key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> PIO_key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> PIO_key_s1_burst_adapter:sink0_endofpacket
	...
	wire    [2:0] pio_key_s1_burst_adapter_source0_channel;                 // PIO_key_s1_burst_adapter:source0_channel -> PIO_key_s1_agent:cp_channel
	...
	wire          pio_switch_s1_agent_rdata_fifo_out_valid;                 // PIO_switch_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pio_switch_s1_agent_rdata_fifo_out_data;                  // PIO_switch_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          pio_switch_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> PIO_switch_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> PIO_switch_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> PIO_switch_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // PIO_switch_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> PIO_switch_s1_agent:rdata_fifo_sink_error
	...
	wire          pio_key_s1_agent_rdata_fifo_out_valid;                    // PIO_key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pio_key_s1_agent_rdata_fifo_out_data;                     // PIO_key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          pio_key_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_002:in_0_ready -> PIO_key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                        // avalon_st_adapter_002:out_0_valid -> PIO_key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                         // avalon_st_adapter_002:out_0_data -> PIO_key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                        // PIO_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                        // avalon_st_adapter_002:out_0_error -> PIO_key_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (PIO_switch_reset_reset_bridge_in_reset_reset), //                    reset.reset
		...
		.av_write               (PIO_switch_s1_write),                          //                         .write
		.av_readdata            (PIO_switch_s1_readdata),                       //                         .readdata
		.av_writedata           (PIO_switch_s1_writedata),                      //                         .writedata
		.av_chipselect          (PIO_switch_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (PIO_switch_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		...
		.cp_ready                (pio_switch_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_switch_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_switch_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_switch_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_switch_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_switch_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_switch_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_switch_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (pio_switch_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (pio_switch_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (pio_switch_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (pio_switch_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (pio_switch_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	hps_systeem_mm_interconnect_0_router router (
	...
	hps_systeem_mm_interconnect_0_router router_001 (
	...
	hps_systeem_mm_interconnect_0_router_002 router_002 (
	...
	hps_systeem_mm_interconnect_0_router_002 router_003 (
	...
	hps_systeem_mm_interconnect_0_router_002 router_004 (
	...
	altera_merlin_burst_adapter #(
	...
	) pio_switch_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                     //       cr0.clk
		.reset                 (PIO_switch_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (pio_switch_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_switch_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_switch_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_switch_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_switch_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_switch_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	hps_systeem_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (PIO_switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_systeem_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (PIO_switch_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_switch_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (pio_switch_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (pio_switch_s1_agent_rdata_fifo_out_ready),     //         .ready
