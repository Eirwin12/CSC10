...
module hps_systeem_mm_interconnect_0 (
	...
	wire  [112:0] pio_switch_s1_agent_rf_source_data;                       // PIO_switch_s1_agent:rf_source_data -> PIO_switch_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] pio_switch_s1_agent_rsp_fifo_out_data;                    // PIO_switch_s1_agent_rsp_fifo:out_data -> PIO_switch_s1_agent:rf_sink_data
	...
	wire  [111:0] pio_switch_s1_agent_rp_data;                              // PIO_switch_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [111:0] pio_led_s1_agent_rp_data;                                 // PIO_led_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> PIO_switch_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // PIO_switch_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> PIO_switch_s1_burst_adapter:sink0_channel
	...
	wire  [111:0] pio_switch_s1_burst_adapter_source0_data;                 // PIO_switch_s1_burst_adapter:source0_data -> PIO_switch_s1_agent:cp_data
	wire          pio_switch_s1_burst_adapter_source0_ready;                // PIO_switch_s1_agent:cp_ready -> PIO_switch_s1_burst_adapter:source0_ready
	wire    [1:0] pio_switch_s1_burst_adapter_source0_channel;              // PIO_switch_s1_burst_adapter:source0_channel -> PIO_switch_s1_agent:cp_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> PIO_led_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // PIO_led_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> PIO_led_s1_burst_adapter:sink0_channel
