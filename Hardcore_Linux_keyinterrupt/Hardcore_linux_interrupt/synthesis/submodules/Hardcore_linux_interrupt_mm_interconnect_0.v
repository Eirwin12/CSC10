// Hardcore_linux_interrupt_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Hardcore_linux_interrupt_mm_interconnect_0 (
	...
	wire          pio_led_s1_agent_rp_valid;                                // PIO_LED_s1_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] pio_led_s1_agent_rp_data;                                 // PIO_LED_s1_agent:rp_data -> router_002:sink_data
	wire          pio_led_s1_agent_rp_ready;                                // router_002:sink_ready -> PIO_LED_s1_agent:rp_ready
	wire          pio_led_s1_agent_rp_startofpacket;                        // PIO_LED_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          pio_led_s1_agent_rp_endofpacket;                          // PIO_LED_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          pio_key_s1_agent_rp_valid;                                // PIO_KEY_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] pio_key_s1_agent_rp_data;                                 // PIO_KEY_s1_agent:rp_data -> router_003:sink_data
	wire          pio_key_s1_agent_rp_ready;                                // router_003:sink_ready -> PIO_KEY_s1_agent:rp_ready
	wire          pio_key_s1_agent_rp_startofpacket;                        // PIO_KEY_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pio_key_s1_agent_rp_endofpacket;                          // PIO_KEY_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> PIO_LED_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> PIO_LED_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // PIO_LED_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> PIO_LED_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> PIO_LED_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> PIO_LED_s1_burst_adapter:sink0_endofpacket
	wire          pio_led_s1_burst_adapter_source0_valid;                   // PIO_LED_s1_burst_adapter:source0_valid -> PIO_LED_s1_agent:cp_valid
	wire  [111:0] pio_led_s1_burst_adapter_source0_data;                    // PIO_LED_s1_burst_adapter:source0_data -> PIO_LED_s1_agent:cp_data
	wire          pio_led_s1_burst_adapter_source0_ready;                   // PIO_LED_s1_agent:cp_ready -> PIO_LED_s1_burst_adapter:source0_ready
	wire    [1:0] pio_led_s1_burst_adapter_source0_channel;                 // PIO_LED_s1_burst_adapter:source0_channel -> PIO_LED_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> PIO_KEY_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> PIO_KEY_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // PIO_KEY_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> PIO_KEY_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> PIO_KEY_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> PIO_KEY_s1_burst_adapter:sink0_endofpacket
	wire          pio_key_s1_burst_adapter_source0_valid;                   // PIO_KEY_s1_burst_adapter:source0_valid -> PIO_KEY_s1_agent:cp_valid
	wire  [111:0] pio_key_s1_burst_adapter_source0_data;                    // PIO_KEY_s1_burst_adapter:source0_data -> PIO_KEY_s1_agent:cp_data
	wire          pio_key_s1_burst_adapter_source0_ready;                   // PIO_KEY_s1_agent:cp_ready -> PIO_KEY_s1_burst_adapter:source0_ready
	wire    [1:0] pio_key_s1_burst_adapter_source0_channel;                 // PIO_KEY_s1_burst_adapter:source0_channel -> PIO_KEY_s1_agent:cp_channel
	...
	wire          pio_led_s1_agent_rdata_fifo_out_valid;                    // PIO_LED_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pio_led_s1_agent_rdata_fifo_out_data;                     // PIO_LED_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          pio_led_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter:in_0_ready -> PIO_LED_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> PIO_LED_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> PIO_LED_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // PIO_LED_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> PIO_LED_s1_agent:rdata_fifo_sink_error
	wire          pio_key_s1_agent_rdata_fifo_out_valid;                    // PIO_KEY_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] pio_key_s1_agent_rdata_fifo_out_data;                     // PIO_KEY_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          pio_key_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_001:in_0_ready -> PIO_KEY_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> PIO_KEY_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> PIO_KEY_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // PIO_KEY_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> PIO_KEY_s1_agent:rdata_fifo_sink_error
	...
	Hardcore_linux_interrupt_mm_interconnect_0_router router (
	...
	Hardcore_linux_interrupt_mm_interconnect_0_router router_001 (
	...
	Hardcore_linux_interrupt_mm_interconnect_0_router_002 router_002 (
	...
	Hardcore_linux_interrupt_mm_interconnect_0_router_002 router_003 (
	...
	Hardcore_linux_interrupt_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (PIO_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (PIO_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (PIO_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (PIO_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardcore_linux_interrupt_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
